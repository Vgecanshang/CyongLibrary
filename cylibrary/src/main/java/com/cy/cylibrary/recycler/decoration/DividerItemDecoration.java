package com.cy.cylibrary.recycler.decoration;
...
public class DividerItemDecoration extends RecyclerView.ItemDecoration {
    ...
    private DividerItemDecoration(int height, int lPadding, int rPadding, int colour) {
        mHeight = height;
        mLPadding = lPadding;
        mRPadding = rPadding;
        mPaint = new Paint();
    ...
    public static class Builder {
        ...
        public DividerItemDecoration build() {
            return new DividerItemDecoration(mHeight, mLPadding, mRPadding, mColour);
        }
    }
}
