...
import com.cy.cylibrary.recycler.progressindicator.AVLoadingIndicatorView;
import com.cy.cylibrary.recycler.recyclerview.ProgressStyle;
...
public class LoadingFooter extends RelativeLayout implements ILoadMoreFooter {
    ...
    private int hintColor = R.color.font_color_gray;
    ...
    public void init(Context context) {
        ...
        indicatorColor = ContextCompat.getColor(getContext(), R.color.font_color_gray);
